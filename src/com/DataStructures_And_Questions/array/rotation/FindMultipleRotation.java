...
import com.DataStructures_And_Questions.array.ArrayRotate;
...
public class FindMultipleRotation {
    ...
    /**
     * @Pseudo Instead of doing kArr[i] rotation operation everytime on inputArr,
     * We do kArr[i]-kArr[i-1] operation on ROTATED ARRAY from operation kArr[i-1]-kArr[i-2]
     * @PreRequisite kArr should be sorted in ascending order. Duplicates can be handled by this algo
     * @Analysis Sorting of kArr will take best case O(log n) if we use best algorithim
