...
public class InfixToPostfix {
	 ...
	 *   	- we see if current operator has higher prec than operator on top of stack, we push the current operator
	 *   	- else if current operator has lower prec than ope on topOfStack, we pop and append ALL operators
