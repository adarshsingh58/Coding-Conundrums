package com.datastructures.Arrays.arrayReversal;
...
public class ArrayReverse {
	 ...
	 * @param inputArr 
	 * @Pseudo
	 * Input array arr[] size n, indexed i. Output array outputArr[n];
	 * 	for(i=0 till n-1)	
	 * 		outputArr[i] = inputArr[n-1]
	 * 
	 * @Analysis
	 *  outputArr of same size as of input is used, hence space complexity is O(n)
	...
	/**
	 * @Pseudo
	 * 	We will traverse till n/2 where n is the size of the input array
	 *  swap(arr[i], arr[n-1-i]) till i<n/2
	 *  
	 *  @Analysis
	 *  	No Extra array is used, only one variable n is used, which is also optional, hence space complexity = O(1)
